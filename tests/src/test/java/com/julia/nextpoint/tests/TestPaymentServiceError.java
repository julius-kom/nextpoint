...
public class TestPaymentServiceError extends BaseTest {
    ...
    @Test
    @DisplayName("Return 502 when Payment Service returns 500")
    void testPaymentServiceError() {

        Allure.step("Configure Payment Service error");
        paymentStub.stubPaymentServiceError();
        ...
        paymentStub.verifyPaymentRequest(200);
    }
}