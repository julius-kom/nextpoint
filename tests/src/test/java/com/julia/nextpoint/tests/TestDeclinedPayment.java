...
public class TestDeclinedPayment extends BaseTest {
    ...
    @Test
    @DisplayName("Create trip and decline payment")
    void testDeclinedPayment() {

        Allure.step("Configure unsuccessful payment");
        ...
        assertThat(createdBooking.getTravelers())
                .as("The number of travelers is incorrect.").isEqualTo(2);
        ...
        assertThat(createdBooking.getStatus())
                .as("The booking status is incorrect.").isEqualTo("PAYMENT_FAILED");
        ...
        TripResponse tripAfterBooking = tripApi.getTrip(createdTrip.getId());
